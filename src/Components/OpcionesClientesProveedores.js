...
function OpcionesClientesProveedores() {
  return (
    <div className="mt-20 ml-8 bg-paleta-MoradoFondo/70 w-full max-w-[1000px] self-center min-w-min p-16 rounded-3xl mb-24  px-16 shadow-lg h-full max-h-[85%]">
      <div className="flex">
        <NavLink
          className={(args) =>
            `${
      ...
      <div className="mt-6 text-left">
        ...
        <div className="pb-1 pl-2 flex grid-flow-col text-xl pt-5 ">
          <button className="self-start text-left mr-16">
            <p className="text-left">Kim Minji</p>
          </button>
          <button className="self-start text-left ">
            <p className="text-left">Consultor Contable</p>
          </button>
          <button className="self-start text-left ml-6 mr-9 ">
            <p className="text-left">Carrera 41B #83-43</p>
          </button>
          <button className="self-start text-left mr-8">
...
export default OpcionesClientesProveedores;
