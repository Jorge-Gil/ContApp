              ...
              <div className="grid grid-cols-2  mb-6">
                ...
                <div className="mb-4">
                  ...
                  <Field
                    ...
                    className="appearance-none border rounded w-full py-2 px-3  max-w-md text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  />
                  <ErrorMessage
                    name="Contrasenia"
                    component="span"
...
export default OpcionesProveedoresAjustes;
